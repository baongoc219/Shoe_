...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./css/sp/sp_orders.css">
...
<div class="app">
    ...
    <div class="content row">
        ...
        <div class="content-frame col-md-9">
            <button id="create-btn">Create new style</button>
            <div class="component--search">
                <input type="text" placeholder="Search for orders by name"/>
            ...
            <div class="result-nodes">
                <table class="result-table">
                    ...
                    <tr>
                        ...
                        <td><img src="./assets/shoes/shoes_1.jpg" alt="Style"/></td>
                        <td>Yellow/Violet Gradient</td>
