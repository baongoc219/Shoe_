...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./css/admin/news_create.css">
...
<div class="app">
    ...
    <div class="content row">
        ...
        <div class="content-frame col-md-9">
            <form id="admin-news-create-form" action="NewsServlet" method="post">
                <div>
                ...
                <div>
                    ...
                    <textarea placeholder="Enter your news content" id="news_content" name="news_content" required></textarea>
                </div>
                <div>
                    <input id="btn--submit" type="submit" value="Create news">
                </div>
            </form>
        </div>
    </div>
